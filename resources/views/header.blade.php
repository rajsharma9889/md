        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret"
                    ...
                    <img src="{{ asset('public/assets/images/avatars/avatar-2.png') }}" class="user-img"
                        alt="user avatar">
                    <div class="user-info">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item d-flex align-items-center" href="javascript:;"
                            onclick="ajaxModal('{{ url('ajaxModal/modal_files.admin_profile') }}', sendObj({'_token' : '{{ csrf_token() }}'}))"><i
                                class="bx bx-user fs-5"></i><span>Profile</span></a></li>
                    <li><a class="dropdown-item d-flex align-items-center" href="javascript:;"
                            onclick="ajaxModal('{{ url('ajaxModal/modal_files.admin_change_password') }}', sendObj({'_token' : '{{ csrf_token() }}'}))"><i
                                class="bx bx-lock fs-5"></i><span>Change Password</span></a></li>
                    <li>
