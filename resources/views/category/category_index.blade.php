                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="py-1">
                                            <a class="dropdown-item px-3" style="all: unset; cursor: pointer;"
                                                href="{{ route('admin.category') }}/change_status/@{{ item.id }}">@{{ item.status == 1 ? "Mark Inactive" : "Mark Active" }}</a>
                                        </li>
                                        <li class="py-1">
                                            <a href="{{ route('add_category') }}/@{{ item.id }}"
                                                class="dropdown-item px-3" style="all: unset; cursor: pointer;">Edit</a>
                                        </li>
